...
constexpr ledc_timer_bit_t LEDC_DUTY_RES = LEDC_TIMER_13_BIT;
...
constexpr ledc_channel_t LEDC_CHANNEL_BLUE = LEDC_CHANNEL_2;
constexpr ledc_channel_t LEDC_CHANNEL_GAMMA_RED = LEDC_CHANNEL_3;
constexpr ledc_channel_t LEDC_CHANNEL_GAMMA_GREEN = LEDC_CHANNEL_4;
...
constexpr float gamma_correction_lut[101] = {
    ...
    0.033231, 0.036527, 0.040016, 0.043703, 0.047593, 0.051688, 0.055993, 0.060513, 0.065249,
    0.070208, 0.075392, 0.080805, 0.086451, 0.092333, 0.098455, 0.104821, 0.111434, 0.118298,
    0.125416, 0.132792, 0.140428, 0.148329, 0.156498, 0.164938, 0.173653, 0.182645, 0.191919,
    0.201476, 0.211321, 0.221457, 0.231886, 0.242612, 0.253639, 0.264968, 0.276603, 0.288548,
    0.300805, 0.313378, 0.326268, 0.339480, 0.353016, 0.366879, 0.381073, 0.395599, 0.410461,
    0.425662, 0.441204, 0.457091, 0.473325, 0.489909, 0.506846, 0.524138, 0.541789, 0.559801,
    0.578177, 0.596920, 0.616032, 0.635515, 0.655374, 0.675610, 0.696226, 0.717224, 0.738608,
    0.760380, 0.782542, 0.805097, 0.828048, 0.851398, 0.875148, 0.899301, 0.923861, 0.948829,
    0.974208, 1.000000,
};
...
void led_task() {
  ...
  rgb_set_duty_and_update(rgb_led_2_channels, gamma_correction_calculator(BLUEISH_PURPLE_R),
                          gamma_correction_calculator(BLUEISH_PURPLE_G),
                          gamma_correction_calculator(BLUEISH_PURPLE_B));
  vTaskDelay(pdMS_TO_TICKS(1000));

  // Dim to OFF in 5000ms
  example_set_fade_and_start(BLUEISH_PURPLE_R, BLUEISH_PURPLE_G, BLUEISH_PURPLE_B, OFF_R, OFF_G,
                             OFF_B, 5000);
  vTaskDelay(pdMS_TO_TICKS(1000));
